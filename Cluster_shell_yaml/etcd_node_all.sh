...
mkdir -pv $ETCD_SSL
scp ${master_hosts_}:/root/K8s/Software_package/etcd-v3.2.28-linux-amd64.tar.gz /root/K8s/Software_package/
...
tar -xvzf /root/K8s/Software_package/etcd-v3.2.28-linux-amd64.tar.gz  -C /root/K8s/Software_package/
\cp /root/K8s/Software_package/etcd-v3.2.28-linux-amd64/etcd* /usr/local/bin/
. /etc/etcd/etcd.conf
...
rm -rf /root/K8s/Software_package/etcd-v3.2.28-linux-amd64*
